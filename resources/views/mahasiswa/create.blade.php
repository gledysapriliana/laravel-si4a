...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-primary card-outline mb-4">
            ...
            enctype="multipart/form-data"> {{-- enctype="multipart/form-data digunakan jika ada upload file (seperti input type file) --}}
                @csrf
                <!--begin::Body-->
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="prodi_id">
                            @foreach ($prodi as $item) <option value="{{$item->id}}">{{$item->nama}}</option>
                            @endforeach
                        </select>
                        @error('prodi_id')
                        <div class="text-danger">{{$message}}</div>
