...
class FakultasPolicy
{
    ...
    {
        return $user->role === 'admin'; //hanya admin yang boleh nambahin ditabel fakultas
    }
    ...
    {
        return $user->role === 'admin'; //hanya admin yang boleh update ditabel fakultas 
    }
    ...
    {
        return $user->role === 'admin'; //hanya admin yang boleh hapus ditabel fakultas 
    }
